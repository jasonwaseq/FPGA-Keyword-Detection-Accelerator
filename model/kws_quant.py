...
def emit(model, out_dir, origin: str):
    ...
    with open(os.path.join(out_dir, "conv_weights.mem"), "w") as f:
    ...
    with open(os.path.join(out_dir, "dense_weights.mem"), "w") as f:
    ...
    with open(os.path.join(out_dir, "conv_bias.mem"), "w") as f:
    ...
    with open(os.path.join(out_dir, "dense_bias.mem"), "w") as f:
    ...
    with open(os.path.join(out_dir, "kws_weights.h"), "w") as f:
